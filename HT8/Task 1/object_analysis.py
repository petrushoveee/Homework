...
img = cv2.imread("images/picture.jpg")
contours, mu, mc = color_conv.canny_edge(img)
contours1 = color_conv.segmentation(img)
contours2 = color_conv.gauss_filter(img)
f = open("mu.txt", 'w')
for elem in mu:
    print(elem, file=f)
f.close()
...
for elem in mc:
    print(elem, file=f)
f.close()
cv2.imwrite("images/picture_res.jpg", contours)
cv2.imwrite("images/picture_segmentation.jpg", contours1)
cv2.imwrite("images/picture_gauss.jpg", contours2)
